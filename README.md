...
1. Install deps: `pip install -r requirements.in`.
...
4. Open `notebooks/fred_mcp.ipynb` and run the setup cell; it imports `navi.lib.env`
   and confirms the keys are available before you call the MCP endpoints.
